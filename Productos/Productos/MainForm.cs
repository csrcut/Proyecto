...
namespace Clientes
{
	...
	public partial class MainForm : Form
	{
		...
		public void actualizarTabla(){
			try{
				...
				this.myDataAdapter.Fill(this.myDataSet,"registro");
				this.myBindingSource.DataSource=this.myDataSet;
				this.myBindingSource.DataMember="registro";
		...
		void MainFormLoad(object sender, EventArgs e)
		{
			...
			this.myCmdQuery.CommandText="SELECT * FROM registro";
    ...
    //fun.eliminarbebida(this,selectionar);
		...
		private void eliminar(String id){
			String sql ="DELETE FROM registro WHERE(`folio`='" + id + "')";
